...
class Mosaic(Screen):
	...
	if isFHD:
		if config.plugins.Mosaic.howmanyscreens.value == 9:
			...
			skin += """<widget name="window1" scale="1" position="%d,%d" zPosition="1" size="%d,%d" borderWidth="3" transparent="1" />""" % (positions[0][0] - 3, positions[0][1] - 2, windowWidth, windowHeight)
			skin += """<widget name="window2" scale="stretch" position="%d,%d" zPosition="1" size="%d,%d" borderWidth="3" transparent="1" />""" % (positions[1][0] - 3, positions[1][1] - 2, windowWidth, windowHeight)
			skin += """<widget name="window3" scale="stretch" position="%d,%d" zPosition="1" size="%d,%d" borderWidth="3" transparent="1" />""" % (positions[2][0] - 3, positions[2][1] - 2, windowWidth, windowHeight)
			skin += """<widget name="window4" scale="stretch" position="%d,%d" zPosition="1" size="%d,%d" borderWidth="3" transparent="1" />""" % (positions[3][0] - 3, positions[3][1] - 2, windowWidth, windowHeight)
			skin += """<widget name="window5" scale="stretch" position="%d,%d" zPosition="1" size="%d,%d" borderWidth="3" transparent="1" />""" % (positions[4][0] - 3, positions[4][1] - 2, windowWidth, windowHeight)
			skin += """<widget name="window6" scale="stretch" position="%d,%d" zPosition="1" size="%d,%d" borderWidth="3" transparent="1" />""" % (positions[5][0] - 3, positions[5][1] - 2, windowWidth, windowHeight)
			skin += """<widget name="window7" scale="stretch" position="%d,%d" zPosition="1" size="%d,%d" borderWidth="3" transparent="1" />""" % (positions[6][0] - 3, positions[6][1] - 2, windowWidth, windowHeight)
			skin += """<widget name="window8" scale="stretch" position="%d,%d" zPosition="1" size="%d,%d" borderWidth="3" transparent="1" />""" % (positions[7][0] - 3, positions[7][1] - 2, windowWidth, windowHeight)
			skin += """<widget name="window9" scale="stretch" position="%d,%d" zPosition="1" size="%d,%d" borderWidth="3" transparent="1" />""" % (positions[8][0] - 3, positions[8][1] - 2, windowWidth, windowHeight)
			...
			skin += """<widget name="channel3" position="%d,%d" size="%d,30" font="Regular;27" backgroundColor="#ffffff" foregroundColor="#000000" />""" % (positions[2][0], positions[2][1] - 33, windowWidth - 6)
			skin += """<widget name="channel4" position="%d,%d" size="%d,30" font="Regular;27" backgroundColor="#ffffff" foregroundColor="#000000" />""" % (positions[3][0], positions[3][1] - 33, windowWidth - 6)
			skin += """<widget name="window1" scale="stretch" position="%d,%d" zPosition="1" size="%d,%d" borderWidth="3" transparent="1" />""" % (positions[0][0] - 3, positions[0][1] - 2, windowWidth, windowHeight)
			skin += """<widget name="window2" scale="stretch" position="%d,%d" zPosition="1" size="%d,%d" borderWidth="3" transparent="1" />""" % (positions[1][0] - 3, positions[1][1] - 2, windowWidth, windowHeight)
			skin += """<widget name="window3" scale="stretch" position="%d,%d" zPosition="1" size="%d,%d" borderWidth="3" transparent="1" />""" % (positions[2][0] - 3, positions[2][1] - 2, windowWidth, windowHeight)
			skin += """<widget name="window4" scale="stretch" position="%d,%d" zPosition="1" size="%d,%d" borderWidth="3" transparent="1" />""" % (positions[3][0] - 3, positions[3][1] - 2, windowWidth, windowHeight)
			skin += """<widget name="video1" position="%d,%d" zPosition="2" size="%d,%d" backgroundColor="#ffffffff" />""" % (positions[0][0] - 3, positions[0][1] - 2, windowWidth, windowHeight)
		...
		if config.plugins.Mosaic.howmanyscreens.value == 9:
			...
			skin += """<widget name="window1" scale="stretch" position="%d,%d" zPosition="1" size="%d,%d" borderWidth="3" transparent="1" />""" % (positions[0][0] - 2, positions[0][1] - 1, windowWidth, windowHeight)
			skin += """<widget name="window2" scale="stretch" position="%d,%d" zPosition="1" size="%d,%d" borderWidth="3" transparent="1" />""" % (positions[1][0] - 2, positions[1][1] - 1, windowWidth, windowHeight)
			skin += """<widget name="window3" scale="stretch" position="%d,%d" zPosition="1" size="%d,%d" borderWidth="3" transparent="1" />""" % (positions[2][0] - 2, positions[2][1] - 1, windowWidth, windowHeight)
			skin += """<widget name="window4" scale="stretch" position="%d,%d" zPosition="1" size="%d,%d" borderWidth="3" transparent="1" />""" % (positions[3][0] - 2, positions[3][1] - 1, windowWidth, windowHeight)
			skin += """<widget name="window5" scale="stretch" position="%d,%d" zPosition="1" size="%d,%d" borderWidth="3" transparent="1" />""" % (positions[4][0] - 2, positions[4][1] - 1, windowWidth, windowHeight)
			skin += """<widget name="window6" scale="stretch" position="%d,%d" zPosition="1" size="%d,%d" borderWidth="3" transparent="1" />""" % (positions[5][0] - 2, positions[5][1] - 1, windowWidth, windowHeight)
			skin += """<widget name="window7" scale="stretch" position="%d,%d" zPosition="1" size="%d,%d" borderWidth="3" transparent="1" />""" % (positions[6][0] - 2, positions[6][1] - 1, windowWidth, windowHeight)
			skin += """<widget name="window8" scale="stretch" position="%d,%d" zPosition="1" size="%d,%d" borderWidth="3" transparent="1" />""" % (positions[7][0] - 2, positions[7][1] - 1, windowWidth, windowHeight)
			skin += """<widget name="window9" scale="stretch" position="%d,%d" zPosition="1" size="%d,%d" borderWidth="3" transparent="1" />""" % (positions[8][0] - 2, positions[8][1] - 1, windowWidth, windowHeight)
	...
	def __init__(self, session, services):
		...
		self.consoleCmd = ""
		self.Console = MyConsole(self.session)
	...
	def deleteConsoleCallbacks(self):
		if self.consoleCmd in self.Console.appContainers:
			try:
				...
				print(f'[Mosaic] error del self.Console.appContainers[self.consoleCmd].dataAvail[:]{str(e)}')
			try:
				del self.Console.appContainers[self.consoleCmd].appClosed[:]
			except Exception as e:
				print(f'[Mosaic] error self.Console.appContainers[self.consoleCmd].appClosed[:]{str(e)}')
			try:
				del self.Console.appContainers[self.consoleCmd]
			except Exception as e:
				print(f'[Mosaic] error del self.Console.appContainers[self.consoleCmd]{str(e)}')
			try:
				del self.Console.extra_args[self.consoleCmd]
			except Exception as e:
				print(f'[Mosaic] error del self.Console.extra_args[self.consoleCmd]{str(e)}')
			try:
				del self.Console.callbacks[self.consoleCmd]
			except Exception as e:
				print(f'[Mosaic] error del self.Console.callbacks[self.consoleCmd] {str(e)}')
	...
	def get_widget_size(self, widget_name):
		widget = self[widget_name]
		return (widget.instance.size().width(), widget.instance.size().height())
	...
	def makeNextScreenshot(self):
		"""Capture screenshot for current window"""
		try:
			print(f'[Mosaic] makeNextScreenshot Capturing window {self.current_window}')
			global firstscrennshot
			self.namepic = ''
			...
			print(f'[Mosaic] makeNextScreenshot current_service_ref {current_service_ref}')
			if current_service_ref:
				service_ref = current_service_ref.toString()
				print(f'[Mosaic] makeNextScreenshot service_ref {service_ref}')
	...
	def showNextScreenshot(self, result, retval, extra_args):
		try:
			if retval == 0:
				...
				print(f'[Mosaic] showNextScreenshot extra_args Screenshot filename returned from the grab process {extra_args}')
				...
				ref = self.ref_list[self.current_refidx]
				info = self.serviceHandler.info(ref)
				name = info.getName(ref).replace('\xc2\x86', '').replace('\xc2\x87', '')  # Clean channel name
				event_name = self.getEventName(info)  # Get current event (EPG) name
				...
				self["video" + str(self.current_window)].decoder = 0  # Reset decoder index
	...
	def updateCountdown(self, callback=None):
		try:
			...
			if self.countdown == 0:
				self.countdown = config.plugins.Mosaic.countdown.value
				self.working = True
				print("[Mosaic] updateCountdown Service list:", [s.toString() for s in self.ref_list])
